...
(use-package smart-tabs-mode
  :config (smart-tabs-insinuate 'c 'c++ 'java 'javascript 'cperl 'nxml))
...
(use-package rvm
  ...
  :hook (ruby-mode-hook . (lambda () (rvm-activate-corresponding-ruby))))
...
(use-package groovy-mode
  ...
  :config (setq
           lsp-groovy-server-file "/Users/zellio/repos/groovy-language-server/build/libs/groovy-language-server-all.jar"))
...
(use-package pipenv
  ...
  :hook ((python-mode . (lambda ()
                          (unless (and (boundp 'user/pipenv-dir-cache) (string= (pipenv-project?) user/pipenv-dir-cache))
...
(use-package lsp-pyls
  ...
  :config (progn
            ...
            (setq
             lsp-client-packages (delete 'lsp-pyls lsp-client-packages))
